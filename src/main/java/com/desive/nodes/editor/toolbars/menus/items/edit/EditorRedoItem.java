...
package com.desive.nodes.editor.toolbars.menus.items.edit;
...
*/
public class EditorRedoItem extends MenuItem {

    public EditorRedoItem(Dictionary dictionary, KeyCombination accelerator, TabFactory tabFactory) {
        super(dictionary.TOOLBAR_EDITOR_REDO_ITEM);
