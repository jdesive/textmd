...
import com.desive.nodes.editor.toolbars.menus.items.MdStyledPageMenuItem;
...
public class EditorExportPdfItem extends MdStyledPageMenuItem {
    ...
    public EditorExportPdfItem(Dictionary dictionary, TabFactory tabFactory, DialogFactory dialogFactory, boolean cssStyle) {
