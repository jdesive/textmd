...
public abstract class MdStyledPageMenuItem extends MenuItem {
    ...
    public abstract EventHandler<ActionEvent> getClickAction(final Dictionary dictionary, final Stage stage, final TabFactory tabFactory, final boolean cssStyle);
}
