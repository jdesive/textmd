...
public class ExportToPdf extends SaveMachine{
    ...
    public boolean save(File contentFile, MarkdownParser markdownParser, String content, boolean style, Dictionary dictionary) {
        return super.savePdfFile(contentFile,
                markdownParser,
                content,
                style ? dictionary.DIALOG_EXPORT_SUCCESS_HTML_CSS_CONTENT : dictionary.DIALOG_EXPORT_SUCCESS_PDF_CONTENT);
    }
